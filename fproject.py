...
def create_app_ui():
    ...
    html.H1('CDR Analysis with Insights', id='Main_title',style={
  'font-family': 'courier','font-weight':'bold','background-color': '#777799',
  'font-size': '300%','textAlign':'center','color':'red'}),
    
    dcc.Tabs(id="Tabs", value="tab-1",children=[
    dcc.Tab(label="Call Analytics tool" ,id="Call Analytics tool",value="tab-1",
             style={'font-style':'italic','font-weight':'bold','background-color': 'rgba(255, 255, 128, .5)'},
            children = [
    html.Br(),
    html.Br(),
    ...
    dcc.Dropdown(
          ...
          value = "2019-06-20",
          style={'border-style': 'dashed solid','border':'solid',' padding': '1em','margin': '0','font-style':'italic',
                 'background-color':'powdered-blue','font-family':'Bradley Hand','font-size':'160%'}
    ...
    dcc.Dropdown(
      ...
      multi = True,
       style={'border-style': 'dashed solid','border':'solid',' padding': '1em','margin': '0',
                 'background-color':'powdered-blue','font-family':'Bradley Hand','font-size':'160%'}
